...
func (c *userServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.v1.UserService/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) LoginCheckByEmail(ctx context.Context, in *LoginCheckByEmailRequest, opts ...grpc.CallOption) (*LoginCheckByEmailResponse, error) {
	out := new(LoginCheckByEmailResponse)
	err := c.cc.Invoke(ctx, "/api.v1.UserService/LoginCheckByEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetUserByPhone(ctx context.Context, in *GetUserByPhoneRequest, opts ...grpc.CallOption) (*GetUserByPhoneResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.v1.UserService/GetUserByPhone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) LoginCheckByEmail(context.Context, *LoginCheckByEmailRequest) (*LoginCheckByEmailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LoginCheckByEmail not implemented")
}
...
func _UserService_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.v1.UserService/Register",
	}
...
func _UserService_LoginCheckByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoginCheckByEmailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).LoginCheckByEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.v1.UserService/LoginCheckByEmail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).LoginCheckByEmail(ctx, req.(*LoginCheckByEmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_GetUserByPhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.v1.UserService/GetUserByPhone",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "LoginCheckByEmail",
			Handler:    _UserService_LoginCheckByEmail_Handler,
		},
		{
